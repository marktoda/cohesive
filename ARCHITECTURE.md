...
- **[`conventions/`](docs/substrate/conventions/)** — prescriptive component rules read when authoring. Houses [`skill-shape.md`](docs/substrate/conventions/skill-shape.md) (canonical SKILL.md shape, including the §"When to edit SKILL.md alone, and when to edit the design layer first" rule), [`reviewer-agent-shape.md`](docs/substrate/conventions/reviewer-agent-shape.md) (canonical reviewer-agent shape), [`dispatch-protocol.md`](docs/substrate/conventions/dispatch-protocol.md) (the dispatch-prompt template enforcing fresh-eyes-review), and [`substrate-layout.md`](docs/substrate/conventions/substrate-layout.md) (where artifacts live).
...
The plugin ships 9 skills (per [`docs/substrate/architecture/skills.md`](docs/substrate/architecture/skills.md)), 6 reviewer agents (per [`docs/substrate/conventions/reviewer-agent-shape.md`](docs/substrate/conventions/reviewer-agent-shape.md)), 6 runtime references under `references/` (cohesion-rubric, design-pressure-testing, locality-over-centralization, architecture-review-rubric, substrate-model, output-voice), 9 fillable templates under `references/templates/`, 5 architecture docs under `docs/substrate/architecture/` (three-tier-architecture, composition-with-superpowers, fresh-eyes-review, skills, handoffs), 4 convention docs under `docs/substrate/conventions/` (skill-shape, reviewer-agent-shape, dispatch-protocol, substrate-layout), and 2 scripts. The 2026-05-04 `cut-anchor-pin` rewrite hard-cut the contributor-vs-user-facing split: rules about *this repo* live in `docs/substrate/`; the workflow methodology shipped to plugin users lives in `references/` and is cited by skills/agents at runtime. The 2026-05-05 architecture refactor split `docs/substrate/designs/` into `architecture/` (read when changing the system shape) and `conventions/` (read when authoring), and authored the per-skill design layer (`skills.md`) and chain-transition contracts (`handoffs.md`). The dated milestone plan that drove v0.1 is preserved at [`docs/history/plans/2026-05-04-mvp-implementation.md`](docs/history/plans/2026-05-04-mvp-implementation.md). The original design vision is at [`docs/history/initial-design.md`](docs/history/initial-design.md).

The user-facing skill set, chain shape, off-chain diagnostics, and router are enumerated and explained in [`docs/substrate/architecture/skills.md`](docs/substrate/architecture/skills.md). Chain transitions and re-entry edges are in [`docs/substrate/architecture/handoffs.md`](docs/substrate/architecture/handoffs.md).
