...
| **Modify** a SKILL.md body (no scope or seam change) | [`docs/substrate/conventions/skill-shape.md`](docs/substrate/conventions/skill-shape.md) and the closest existing skill |
