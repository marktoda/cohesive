...
> A Codex skill pack for substrate-first agentic engineering. Helps a codebase remember.
...
Cohesive is a Codex plugin. Three implementation tiers under `${CLAUDE_PLUGIN_ROOT}`:
...
Top-level prose lives at the root: `README.md` is the entry point. This file (`AGENTS.md`) is the contributor guide.
...
- prose paragraphs in `README.md` or in this `AGENTS.md`,
