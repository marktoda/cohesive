...
The user's experience: "I asked Cohesive to do the obvious thing and it skipped its own discipline." The substrate's experience: the rewrite's value (delta ledger as inspectable work-shape; end-of-run dual reviewer fence; substrate-coverage verdict) was bypassed by a single freeform user request.
